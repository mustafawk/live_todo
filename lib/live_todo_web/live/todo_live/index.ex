defmodule LiveTodoWeb.TodoLive.Index do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     ...
     |> stream(:todos, Todos.list_todos(socket.assigns.current_scope))}
  end
  ...
  def handle_info({type, %LiveTodo.Todos.Todo{}}, socket)
    ...
    {:noreply, stream(socket, :todos, Todos.list_todos(socket.assigns.current_scope), reset: true)}
  end
end
