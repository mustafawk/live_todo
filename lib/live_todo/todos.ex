defmodule LiveTodo.Todos do
  ...
  def subscribe_todos(%Scope{} = scope) do
    ...
    Phoenix.PubSub.subscribe(LiveTodo.PubSub, "user:#{key}:todos")
  end

  defp broadcast(%Scope{} = scope, message) do
    key = scope.user.id

    Phoenix.PubSub.broadcast(LiveTodo.PubSub, "user:#{key}:todos", message)
  end
